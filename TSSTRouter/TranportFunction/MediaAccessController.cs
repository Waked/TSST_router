...
namespace TSSTRouter
{
    ...
    partial class TransportFunction
    {
        class MediaAccessController
        {
            ...
            public MediaAccessController(ushort rxPort, ushort txPort, PacketHandlingCallback packetHandlingCallback)
            {
                this.rxPort = rxPort;
                this.txPort = rxPort;
            ...
            void ReadCallback(IAsyncResult ar)
            {
                ...
                try
                {
                    ...
                    if (bytesRead > 0)
                    {
                        ...
                        Log.WriteLine("[RX] <== Received on interface {0}", receivedMsg.interfaceId);
                    }
